...
def main():
    scripts = ['graph_default_assymetric2-1-1.py','graph_default_assymetric2-2.py','graph_default_assymetric3-1.py','graph_default_assymetric2-1-1-1.py','graph_default_assymetric2-2-1.py','graph_default_assymetric3-1-1.py','graph_default_assymetric3-2.py','graph_default_assymetric4-1.py']
